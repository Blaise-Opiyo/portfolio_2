...
import covid19_analysis_screen from '../assets/covid analysis normal size top.PNG'
        ...
        <div className="blog-home">
            <div className="main-section">
                ...
                <div ref={projects_sec} className="projects-section">
                    ...
                    <div className="project-container React">
                        <img src={covid19_analysis_screen} alt="project-thumb"/>
                        <div className="project-details">
                            <h3>COVID-19 Analysis</h3>
                            <div>
                                <p>React | July 2023</p>
                                <p><a href="https://covid19-analysys.netlify.app/" target="_blank" rel="noreferrer">view project</a></p>
                            </div>
                        </div>
                    </div>
                    {/* <div className="project-container Nodejs">
                ...
                <footer>
                    <p><>&copy;</> <> &middot; </> Blaise Opiyo <>&middot;</> All rights reserved <>&middot;</> 2023</p>
                </footer>
            </div>
        </div>
    )
